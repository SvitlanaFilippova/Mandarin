                ...
                Column(
                    ...
                    val content = when (pickupPoint) {
                        OrderPickupPoint.PIZZERIA -> listOf(
                            R.string.pickup_pizzeria_address to Typography.SmallTextStyle
                        )

                        OrderPickupPoint.CAFE -> listOf(
                            R.string.pickup_cafe_address to Typography.SmallTextStyle
                        )

                        OrderPickupPoint.BOTH -> listOf(
                            R.string.pickup_both_title to Typography.RegularTextStyle,
                            R.string.pickup_both_description to Typography.SmallTextStyle,
                            R.string.pickup_pizzeria_address to Typography.SmallTextStyle,
                            R.string.pickup_cafe_address to Typography.SmallTextStyle
                        )
                    }
