package com.mandarinkafe.mandarin.shared.cart.di
...
import com.mandarinkafe.mandarin.shared.cart.data.impl.CartRepositoryImpl
import com.mandarinkafe.mandarin.shared.cart.data.impl.RecommendsSchemaRepositoryImpl
import com.mandarinkafe.mandarin.shared.cart.data.sharedprefs.CartStorage
import com.mandarinkafe.mandarin.shared.cart.data.sharedprefs.CartStorageImpl
import com.mandarinkafe.mandarin.shared.cart.domain.api.CartRepository
import com.mandarinkafe.mandarin.shared.cart.domain.api.RecommendsSchemaRepository
import com.mandarinkafe.mandarin.shared.cart.domain.impl.CartInteractorImpl
import com.mandarinkafe.mandarin.shared.cart.domain.impl.GetAllRecommendsUseCaseImpl
import com.mandarinkafe.mandarin.shared.cart.domain.impl.GetCommonRecommendsUseCaseImpl
import com.mandarinkafe.mandarin.shared.cart.domain.impl.GetRecommendsUseCaseImpl
