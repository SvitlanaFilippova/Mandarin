...
import com.mandarinkafe.mandarin.features.address.presentation.ui.components.ChosenLocationPin
import com.mandarinkafe.mandarin.features.address.presentation.ui.components.HandleAddressEffects
import com.mandarinkafe.mandarin.features.address.presentation.ui.components.RequestLocationPermission
import com.mandarinkafe.mandarin.features.address.presentation.viewmodel.AddressContract.AddressEvent
import com.mandarinkafe.mandarin.features.address.presentation.viewmodel.AddressContract.AddressEvent.CameraMoved
...
//            }
            ...
            SearchBarInputField(
                modifier = Modifier
                    .padding(Dimens.MarginSmall8)
                    .clickable(onClick = {
                        onEvent(AddressEvent.GoToTextSearch(addressValue))
                    }),
                query = addressValue,
                enabled = false,
        ...
        )
        {
            ...
            ButtonWithText(
                ...
                onClick = { onEvent(AddressEvent.GoToAddressDetails) }
            )
