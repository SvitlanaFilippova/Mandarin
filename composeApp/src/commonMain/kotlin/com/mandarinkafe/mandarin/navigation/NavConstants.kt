...
object NavConstants {
    ...
    // --- With args ---
    const val CART_SCREEN_ROUTE_WITH_ARGS =
        "$CART_SCREEN_ROUTE?$KEY_SNACKBAR_MESSAGE={$KEY_SNACKBAR_MESSAGE}"

    const val ADDRESS_SCREEN_ROUTE_WITH_ARGS =
        "$ADDRESS_SCREEN_ROUTE?$KEY_ADDRESS_JSON={$KEY_ADDRESS_JSON}&$KEY_RETURN_TO_ROUTE={$KEY_RETURN_TO_ROUTE}"

    const val ADDRESS_DETAILS_ROUTE_WITH_ARGS =
        "$ADDRESS_DETAILS_ROUTE?$KEY_ADDRESS_JSON={$KEY_ADDRESS_JSON}&$KEY_IS_EDIT_MODE={$KEY_IS_EDIT_MODE}&$KEY_RETURN_TO_ROUTE={$KEY_RETURN_TO_ROUTE}"

    const val MEAL_DETAILS_ROUTE_WITH_ARGS =
        "$MEAL_DETAILS_ROUTE?$KEY_MEAL_JSON={$KEY_MEAL_JSON}&$KEY_MEAL_ID={$KEY_MEAL_ID}&$KEY_IS_EDIT_MODE={$KEY_IS_EDIT_MODE}"
    ...
    const val ORDER_INFO_ROUTE_WITH_ARGS =
        "$ORDER_INFO_ROUTE?$KEY_ORDER_ID={$KEY_ORDER_ID}&$KEY_FROM_ORDER_CREATION={$KEY_FROM_ORDER_CREATION}"
