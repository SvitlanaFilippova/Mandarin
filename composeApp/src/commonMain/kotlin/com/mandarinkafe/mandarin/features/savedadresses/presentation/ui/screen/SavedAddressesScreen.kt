...
import com.mandarinkafe.mandarin.shared.presentation.viewmodel.rememberSavedAddressesViewModel
...
fun SavedAddressesScreen(
    ...
    val viewModel = rememberSavedAddressesViewModel()
    ...
    LazyColumn(
        ...
        item {
            ScreenTitleWithBackButton(
                name = stringResource(MR.strings.saved_addresses),
