...
private fun addCafePins(mapView: MapView, zoomIsClose: Boolean) {
    ...
    val pinIconCafeRes = if (zoomIsClose) R.drawable.map_pin_cafe else R.drawable.map_pin_small
    val pinIconPizzaRes = if (zoomIsClose) R.drawable.map_pin_pizza else R.drawable.map_pin_small
