...
[**Александр Родионов
**](https://github.com/AlexDeyl) — [серверная часть проекта](https://github.com/SvitlanaFilippova/Mandarin-server)
...
📦 Полноценная Android-версия приложения (APK) доступна для скачивания
в [RuStore](https://www.rustore.ru/catalog/app/com.mandarinkafe.mandarin) и в
